...
## How Leiva works:
Leiva is written primary in [Go](https://golang.org/) and its resultant code is compiled with [gcc](https://github.com/gcc-mirror/gcc). The interpreter and the translater of Leiva is written in Go, then the compilation process takes place in C.
